...
static int has_ext(const char *ext) {
    ...
    if (wglGetExtensionsStringARB == NULL || GLADWGLhdc == NULL)
...
int gladLoadWGLLoader(GLADloadproc load, HDC hdc) {
    ...
    if (wglGetExtensionsStringARB == NULL && wglGetExtensionsStringEXT == NULL) return false;
    find_coreWGL(hdc);
