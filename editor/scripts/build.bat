...
set generalLinkingFlags=-lglfw3 -lcalmar_engine -lkernel32 -luser32 -lgdi32 -lwinspool -lcomdlg32 -ladvapi32 -lshell32 -lole32 -loleaut32 -luuid -lodbc32 -lopengl32 -lmsvcrtd.lib -llibcmt
...
set preDefinedMacros=-D_DEBUG -DCALMAR_IMPORT -D_CRT_SECURE_NO_WARNINGS -DGLFW_INCLUDE_NONE
